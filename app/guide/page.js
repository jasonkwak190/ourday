    ...
    <div className="page-wrapper">
      ...
      <section className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          {CATEGORIES.map((cat) => (
            <div key={cat.title} className="card cursor-pointer" style={{ padding: '1rem' }}>
      ...
      <section>
        ...
        <div className="flex flex-col gap-3">
          {POPULAR_GUIDES.map((g) => (
            <div key={g.title} className="card cursor-pointer flex items-start gap-3">
